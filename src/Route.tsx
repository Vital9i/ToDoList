...
type RouteProps = {
    route: RouteType
    toggleFTIsBooked: (flightTableID: string, routeID: string, newBooked: boolean) => void;
...
export const Route = ({
    ...
    const handleToggleFTIsBooked = (newBooked:boolean) => {
        toggleFTIsBooked(flightTableID,route.id, newBooked)
    }
